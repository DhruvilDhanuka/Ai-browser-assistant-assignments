...
from app.intentParser import parse_intent as IntentParser
...
class BrowserAgent:
    ...
    def run(self, user_input: str) -> str:
        ...
        parsed = IntentParser(user_input)
        if parsed["needs_clarification"]:
            return f"First clarify this before proceeding: {parsed['clarification_question']}"
